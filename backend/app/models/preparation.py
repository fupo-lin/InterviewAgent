...
class JDAnalysis(Base):
    ...
    schema_version: Mapped[str] = mapped_column(String(80), default="JDAnalysis.v1", nullable=False)
...
class ResumeProfile(Base):
    ...
    agent_run_id: Mapped[int | None] = mapped_column(ForeignKey("agent_runs.id"), nullable=True)
    schema_version: Mapped[str] = mapped_column(String(80), default="ResumeProfile.v1", nullable=False)
    evidence_refs: Mapped[list | None] = mapped_column(JSON, nullable=True)
    content: Mapped[dict] = mapped_column(JSON, nullable=False)
    raw_response: Mapped[dict | None] = mapped_column(JSON, nullable=True)
    status: Mapped[str] = mapped_column(String(20), default="normal", nullable=False)
...
class GapAnalysis(Base):
    ...
    agent_run_id: Mapped[int | None] = mapped_column(ForeignKey("agent_runs.id"), nullable=True)
    schema_version: Mapped[str] = mapped_column(String(80), default="GapAnalysis.v1", nullable=False)
    evidence_refs: Mapped[list | None] = mapped_column(JSON, nullable=True)
    content: Mapped[dict] = mapped_column(JSON, nullable=False)
    raw_response: Mapped[dict | None] = mapped_column(JSON, nullable=True)
    status: Mapped[str] = mapped_column(String(20), default="normal", nullable=False)
...
class InterviewPlan(Base):
    ...
    agent_run_id: Mapped[int | None] = mapped_column(ForeignKey("agent_runs.id"), nullable=True)
    schema_version: Mapped[str] = mapped_column(String(80), default="InterviewPlan.v1", nullable=False)
    evidence_refs: Mapped[list | None] = mapped_column(JSON, nullable=True)
    content: Mapped[dict] = mapped_column(JSON, nullable=False)
    raw_response: Mapped[dict | None] = mapped_column(JSON, nullable=True)
    status: Mapped[str] = mapped_column(String(20), default="normal", nullable=False)
...
class ResumeAuthenticityReport(Base):
    ...
    agent_run_id: Mapped[int | None] = mapped_column(ForeignKey("agent_runs.id"), nullable=True)
    schema_version: Mapped[str] = mapped_column(String(80), default="ResumeAuthenticityReport.v1", nullable=False)
    evidence_refs: Mapped[list | None] = mapped_column(JSON, nullable=True)
    content: Mapped[dict] = mapped_column(JSON, nullable=False)
    raw_response: Mapped[dict | None] = mapped_column(JSON, nullable=True)
    status: Mapped[str] = mapped_column(String(20), default="normal", nullable=False)
...
class ResumeRewriteResult(Base):
    ...
    agent_run_id: Mapped[int | None] = mapped_column(ForeignKey("agent_runs.id"), nullable=True)
    schema_version: Mapped[str] = mapped_column(String(80), default="ResumeRewriteResult.v1", nullable=False)
    evidence_refs: Mapped[list | None] = mapped_column(JSON, nullable=True)
    content: Mapped[dict] = mapped_column(JSON, nullable=False)
    raw_response: Mapped[dict | None] = mapped_column(JSON, nullable=True)
    status: Mapped[str] = mapped_column(String(20), default="normal", nullable=False)
